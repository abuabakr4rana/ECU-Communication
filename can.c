 ...
 ********************************************************************/
    ...
    /* STD_ID */
    CAN_0.BUF[0].ID.B.STD_ID = 0x501; /* Change to the correct ID! */
    ...
    /* STD_ID */
    CAN_0.BUF[1].ID.B.STD_ID = 0x502; /* Change to the correct ID! */
    ...
    /* STD_ID */
    CAN_0.BUF[2].ID.B.STD_ID = 0x503; /* Change to the correct ID! */
    ...
    /* STD_ID */
    CAN_0.BUF[3].ID.B.STD_ID = 0x504; /* Change to the correct ID! */
    ...
    /* STD_ID */
    CAN_0.BUF[4].ID.B.STD_ID = 0x505; /* Change to the correct ID! */
